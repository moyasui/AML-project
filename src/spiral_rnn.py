...
spacial_dim = 2
n_hidden = 32
test_indx = 1   # which particle to test
...
# model.save('trained_models/spiral_100.h5')
...
ax.plot(pred_x_lstm, pred_y_lstm, label='LSTM Predicted Sequence')
ax.plot(pred_x_vanilla, pred_y_vanilla, label='Vanilla Predicted Sequence')
...
# save plot
plt.savefig('./Analysis/figs/spiral_rnn.pdf')
